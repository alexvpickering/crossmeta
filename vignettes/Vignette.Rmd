...
You will need the _homologene.data_ file which is used to map entrez gene ids 
from supported species to the homologous human gene symbol. The _homologene.data_
file can be obtained from [Homologene](http://1.usa.gov/240COzR).
...
column in fData._ Two options to do so are shown:
