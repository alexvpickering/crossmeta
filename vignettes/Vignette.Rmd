...
You will need the homologene.data file in order to annotate all probes with the
homologous human gene symbol. The homologene.data file can be obtained from
[Homologene](http://1.usa.gov/240COzR).
...
If you can't find the bioconductor annotation data package (or none exists), hit
enter with a blank entry and crossmeta will attempt annotation using the
feature data from the study in question.
...
If you need to look up experimental details for the study (e.g. tissue and group)
