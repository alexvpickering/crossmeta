...
headers of the raw Illumina data files yourself.
...
If the above corrections are not possible (e.g. because there are no detection p-values),
you may have to proceed without certain GSEs that cannot be corrected.
